...
mixin _$CasaModel {
 ...
 String get id; String get nome; String get codigo; String get criadoPor;@TimestampConverter() DateTime get criadoEm;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,nome,codigo,criadoPor,criadoEm);

@override
String toString() {
  return 'CasaModel(id: $id, nome: $nome, codigo: $codigo, criadoPor: $criadoPor, criadoEm: $criadoEm)';
}
...
@useResult
$Res call({
 String id, String nome, String codigo, String criadoPor,@TimestampConverter() DateTime criadoEm
});
...
/// Create a copy of CasaModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? nome = null,Object? codigo = null,Object? criadoPor = null,Object? criadoEm = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String nome,  String codigo,  String criadoPor, @TimestampConverter()  DateTime criadoEm)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CasaModel() when $default != null:
return $default(_that.id,_that.nome,_that.codigo,_that.criadoPor,_that.criadoEm);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String nome,  String codigo,  String criadoPor, @TimestampConverter()  DateTime criadoEm)  $default,) {final _that = this;
switch (_that) {
case _CasaModel():
return $default(_that.id,_that.nome,_that.codigo,_that.criadoPor,_that.criadoEm);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String nome,  String codigo,  String criadoPor, @TimestampConverter()  DateTime criadoEm)?  $default,) {final _that = this;
switch (_that) {
case _CasaModel() when $default != null:
return $default(_that.id,_that.nome,_that.codigo,_that.criadoPor,_that.criadoEm);case _:
  return null;
...
class _CasaModel implements CasaModel {
  const _CasaModel({required this.id, required this.nome, required this.codigo, required this.criadoPor, @TimestampConverter() required this.criadoEm});
...
/// Create a copy of CasaModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? nome = null,Object? codigo = null,Object? criadoPor = null,Object? criadoEm = null,}) {
